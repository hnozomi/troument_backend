...
class Detail extends React.Component {
    ...
    render() {
        ...
        // let title = this.props.detail_todolist.title
        // let tag = this.props.detail_todolist.tag
        // let count = this.props.detail_todolist.count
        // let worry_id = this.props.detail_todolist.worry_id
        // let worry = this.props.detail_todolist.worry
        // let time = this.props.detail_todolist.time
        // let status = this.props.detail_todolist.status
        // let username = this.props.detail_todolist.username
        // let thumbnail = this.props.detail_todolist.user.thumbnail
